...
const projects = [
  { folder:"marketplace", title:"Женский свитшот Saint-Petersburg", category:"Дизайн маркетплейсов", description:"Дизайн карточек товара и rich-контента для маркетплейса.", media:["images/sweatshirt-cover.png","sweatshirt-slide-2.png","sweatshirt-slide-3.png","sweatshirt-rich.png"], task:"Создать визуальную подачу женского свитшота для маркетплейса.", result:"Главная карточка товара, информационные слайды, визуализация образов и rich-контент." },
  { folder:"marketplace", title:"Фен — дизайн карточек для маркетплейса", category:"Дизайн маркетплейсов", description:"Серия карточек товара для фена: главный слайд, демонстрация использования, детали и характеристики продукта.", media:["hairdryer-cover.png","hairdryer-slide-2.png","hairdryer-slide-3.png","hairdryer-slide-4.png"], task:"Создать современную визуальную подачу фена для карточки товара на маркетплейсе.", result:"Главный продающий слайд, демонстрация товара в использовании, визуализация деталей и информационные карточки с характеристиками." },
  { folder:"marketplace", title:"Игровые наушники Phantom", category:"Дизайн маркетплейсов", description:"Яркая карточка товара для игровой электроники с акцентом на характеристики, атмосферу и визуальную подачу продукта.", media:["headphones-cover.png"] },
  ...
  { folder:"marketplace", title:"Средство для купания 3 в 1 для мужчин", category:"Дизайн маркетплейсов", description:"Чистая продуктовая инфографика для мужского уходового средства с акцентом на свойства и объём.", media:["bodywash-cover.png"] },
  { folder:"marketplace", title:"Хлебцы Fitstart", category:"Дизайн маркетплейсов", description:"Яркий дизайн карточки товара для продуктовой категории с акцентом на вкус, низкую калорийность и натуральные ингредиенты.", media:["fitstart-cover.png"] },
  ...
  { folder:"business", title:"Золотые голоса — визуальное оформление концерта", category:"Дизайн для мероприятий · AI-видео", description:"Комплексное визуальное оформление музыкального события: афиша, билет, сценическая анимация и сопутствующие материалы в единой стилистике.", media:["soulmusic-poster.png","soulmusic-ticket.png","images/soulmusic-animation.mp4","soulmusic-thankyou.png","soulmusic-diploma.png"], task:"Создать единое визуальное оформление для музыкального события, чтобы все материалы выглядели целостно и поддерживали атмосферу концерта.", result:"Афиша, билет, анимация для заднего экрана сцены, благодарственное письмо и диплом в единой стилистике." },
